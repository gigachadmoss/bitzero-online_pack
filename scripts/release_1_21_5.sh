...
if [[ "$COMBAT_WEAPONRY_PLUS" == "1" ]]; then
    ...
    mkdir -p target/workingpack/assets/minecraft/items/
    ...
    cp -a cwp_1_21_5/assets/minecraft/items/* target/workingpack/assets/minecraft/items/
    cp -a cwp_1_21_5/assets/minecraft/models/item/* target/workingpack/assets/minecraft/models/item/
